...
Multiselect.prototype = {
	...
	_createInputField: function () {
        ...
        if (typeof this._item.getAttribute('placeholder') != 'object') {
            fieldData.attributes.placeholder = this._item.getAttribute('placeholder');
        }

		var input = m_helper.textField(fieldData),
